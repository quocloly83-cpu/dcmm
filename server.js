...
<head>
  ...
  <style>
    ...
    .box{width:min(92vw,430px);padding:24px;border-radius:24px;background:rgba(255,255,255,.04);border:1px solid rgba(0,255,255,.2);box-shadow:0 0 30px rgba(0,255,255,.12);text-align:center}
    h1{margin-top:0;color:#9ff}
    a{display:block;margin:12px 0;padding:14px;border-radius:14px;text-decoration:none;color:#fff;background:linear-gradient(90deg,#00cfff,#8b00ff,#ff0077)}
  </style>
</head>
<body>
  <div class="box">
...
<head>
  ...
  <style>
    *{box-sizing:border-box}
    ...
    .card{width:min(92vw,460px);border-radius:28px;background:rgba(10,12,18,.84);border:1px solid rgba(0,255,255,.2);box-shadow:0 0 35px rgba(0,255,255,.10),0 0 70px rgba(255,0,140,.08);overflow:hidden}
    ...
    .input{width:100%;height:54px;border:none;outline:none;border-radius:16px;padding:0 14px;color:#fff;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.08);font-size:15px}
    .btn,.btn2{width:100%;height:50px;margin-top:12px;border:none;border-radius:14px;color:#fff;font-weight:700;cursor:pointer}
    ...
    .info{padding:12px;border-radius:16px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.08);margin-bottom:14px;line-height:1.7;font-size:13px}
    .countdown{margin-top:8px;font-weight:700;color:#9ff;font-size:15px}
    .feature{padding:16px;border-radius:18px;margin-bottom:12px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.08)}
    ...
    .switch input:checked + .slider{background:linear-gradient(90deg,#00d9ff,#9900ff)}
...
<body>
  ...
  <script>
    ...
    function saveSession(key) {
      localStorage.setItem("ath_key", key);
    }

    function getSession() {
      return localStorage.getItem("ath_key");
    }
